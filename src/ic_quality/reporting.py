...
def save_ic_quality_outputs(
    ...
    *,
    ...
    """Write CSV/JSON artifacts for an IC-quality review run."""
    ...
    paths = {
        ...
        "html_report": output_dir / "ic_review_report.html",
    }
...
def write_html_review_report(
    ...
    *,
    ...
    """Write a compact auditable HTML report for human IC review."""

    path = Path(path)
    summary = _recommendation_summary(scored_table)
    sections = [
        "<!doctype html>",
        "<html><head><meta charset='utf-8'><title>IC Review Report</title>",
